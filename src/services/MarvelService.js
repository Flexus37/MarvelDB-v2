...
const useMarvelService = () => {
    ...
    const _apiKey = 'apikey=7ff01552b1b96123f3e754d276f403ea';
    ...
    const getComicsList = async (offset = _comicsOffset) => {
    ...
    const _transformComics = (comics) => {
        return {
            ...
            // price: comics.description.match(/\$\d+\.\d{2}$/) ? comics.description.match(/\$\d+\.\d{2}$/) : 'Not available'
        }
    }
